def main(args):
    ...
    url = "https://tw.stock.yahoo.com/rank/foreign-investor-sell?exchange=TAI"
    ...
    sql = "Insert into `defaultdb`.`institutional_inverse` (`rank`, `name`, `code`, `price`, `change`, `buy`, `sell`, `over`, `traded`, `hold`, `ratio`) values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"

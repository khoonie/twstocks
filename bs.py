...
url = "https://tw.stock.yahoo.com/rank/foreign-investor-buy?exchange=TAI"
...
cur = cnx.cursor()
sql = "Insert into `defaultdb`.`institutional` (`rank`, `name`, `code`, `price`, `change`, `buy`, `sell`, `over`, `traded`, `hold`, `ratio`) values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
